...
```bash
claude mcp add --scope user makethisbetter -- npx -y @makethisbetter/mcp
```
...
| Tool | What it does |
|------|-------------|
| `list` | Browse one Project's feedback by `project_handle`, filterable by status or type |
...
Agent:   Picking it up.
         ...
         *makes the code changes*
         ...
         → resolve(feedback_id: "acme/FB-42", pr_url: "https://github.com/you/app/pull/87")
